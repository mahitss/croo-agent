...
export class PrismaService extends PrismaClient implements OnModuleInit, OnModuleDestroy {
  ...
  constructor() {
    ...
    try {
      if (originalUrl) {
        ...
        parsed.searchParams.set('schema', 'payments');
    ...
    const serviceName = process.env.RENDER_SERVICE_NAME || 'Payment Service';
  ...
  private async validateDatabaseSchema() {
    const expectedTables = ['payments', 'escrows', 'settlements', 'refunds'];
    try {
