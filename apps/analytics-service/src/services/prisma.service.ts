...
export class PrismaService extends PrismaClient implements OnModuleInit, OnModuleDestroy {
  ...
  constructor() {
    ...
    const serviceName = process.env.RENDER_SERVICE_NAME || 'Analytics Service';
  ...
  async onModuleDestroy() {
    console.log(`[PRISMA_DISCONNECT_LOG] Disconnect requested from analytics-service PrismaService:`, new Error().stack);
