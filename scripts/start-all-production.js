...
const services = [
  {
    ...
    cmd: 'node',
    args: ['--optimize_for_size', '--max-semi-space-size=1', '--max-old-space-size=72', 'dist/main.js']
  },
  {
    name: 'auth-service',
    ...
    port: 5001,
    cmd: 'node',
    args: ['--optimize_for_size', '--max-semi-space-size=1', '--max-old-space-size=48', 'dist/main.js']
  },
  {
    name: 'agent-service',
